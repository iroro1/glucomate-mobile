...
import { ReadingType, GlucoseReading } from "../types/reading";
import { updateReading } from "../utils/storage";
...
type EditReadingProps = {
  navigation: NativeStackNavigationProp<RootStackParamList, "EditReading">;
  route: RouteProp<RootStackParamList, "EditReading">;
};

export default function EditReading({ navigation, route }: EditReadingProps) {
  const { reading } = route.params;

  const [glucoseLevel, setGlucoseLevel] = useState(reading.value.toString());
  const [readingType, setReadingType] = useState<ReadingType>(reading.type);
    ...
    try {
      ...
      if (result) {
        ...
        Toast.show({
          type: "error",
          text1: "Update Failed",
          text2: "Failed to update reading. Please try again.",
        });
      }
    } catch (error) {
      ...
      >
        <View style={styles.header}>
          ...
          <View style={styles.headerTitleContainer}>
            <Text style={styles.headerTitle}>Edit Reading</Text>
            <Text style={styles.headerSubtitle}>Update your glucose level</Text>
          </View>
              ...
              <View style={styles.actionsContainer}>
                ...
                >
                  ...
                  <Text style={styles.saveButtonText}>
                    {isSaving ? "Updating..." : "Update Reading"}
                  </Text>
                </TouchableOpacity>
